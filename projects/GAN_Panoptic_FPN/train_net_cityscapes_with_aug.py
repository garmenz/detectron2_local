...
# from detectron2.projects.panoptic_fpn import add_Cityscapes_config
from panoptic_fpn.dataset_mapper import CityscapesMapper
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        mapper = CityscapesMapper(cfg, is_train=True, augmentations=train_aug(cfg))
